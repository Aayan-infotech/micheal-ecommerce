    ...
    return (
        <div className="privacy-policy-container">
            <div className="privacy-policy-content">
                ...
                <p>
                    At MIllys, your privacy is our priority. This Privacy Policy outlines how we collect, use, 
                    and safeguard your personal information when you visit or make a purchase on our website. 
                    By using our website, you agree to the practices described herein.
                </p>
                ...
                <p>
                    ...
                    website traffic, and personalize your shopping experience.
                </p>
                ...
                <ul>
                    ...
                    <li>Communicate with you regarding orders, updates, and promotions</li>
                ...
                <ul>
                    <li>
                        <strong>Service Providers:</strong> Payment processors, shipping partners, and IT support services
                    </li>
                    <li>
                ...
                <p>
                    ...
                    <a href="mailto:mike.export@yahoo.com"> mike.export@yahoo.com</a>.
                </p>
                ...
                <p>
                    Email: <a href="mailto:mike.export@yahoo.com">mike.export@yahoo.com</a><br />
                    Phone: +46 73 507 72 76
                </p>
                <p>Thank you for trusting MIllys. Your privacy matters to us!</p>
            </div>
        </div>
    );
};
