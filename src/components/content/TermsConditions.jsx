  ...
  return (
    <div className="privacy-policy-container">
      <div className="privacy-policy-content">
        ...
        <p>
          At MIllys, your privacy is our priority. This Privacy Policy outlines
        ...
        <p>
          ...
          experience, analyze website traffic, and personalize your shopping
          experience.
        </p>
        ...
        <ul>
          ...
          <li>
            Communicate with you regarding orders, updates, and promotions
          </li>
        ...
        <ul>
          <li>
            ...
            partners, and IT support services
          </li>
          <li>
