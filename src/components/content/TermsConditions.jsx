...
import '../content/privacypolicy.css';

const TermsConditions = () => {
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <div className="main-container">
                <h1 className="privacy_policy">Terms Conditions</h1>
                <div className="paragraph">
                    ...
                    <p className="text-para"><strong>Information Collection and Use</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Log Data</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Cookies</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Service Providers</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Security</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Links to Other Sites</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Children’s Privacy</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Changes to This Privacy Policy</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para"><strong>Contact Us</strong></p>
                    <p className="text-para">
                    ...
                    <p className="text-para">
                        ...
                        and modified/generated by <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a>.
                    </p>
                </div>
            </div>
        </div>
